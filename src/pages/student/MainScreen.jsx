      ...
      >
        ...
        <div className="content-wrapper main-screen-content">
          <div className="text-center w-full">
            ...
            >
              ...
              <div
                ...
                className="w-[400px] h-[50px] max-w-[90vw] mt-4 flex bg-[#2d000a] rounded-full shadow-2xl font-bold z-20 transition-all duration-300 mb-4"
              >
                <button
          ...
          <div
            ...
            style={{
              transform: window.innerWidth >= 1600 ? "translateY(10px)" : "translateY(80px)",
            }}
          >
            {(() => {
              const text =
