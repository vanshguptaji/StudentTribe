  ...
  return (
    <footer className="w-full bg-[#efd1d6]">
      <div className="max-w-7xl mx-auto px-4 py-4 sm:py-8 md:py-12 relative">
        ...
        <div className="bg-[#2C1B1B]/90 rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 xl:p-24 flex flex-col lg:flex-row lg:items-start lg:justify-between relative overflow-hidden min-h-[500px] sm:min-h-[460px] md:min-h-[520px] lg:min-h-[490px]">
          {/* Left: Join Community */}
          ...
          <div className="flex-1 flex flex-col sm:flex-row lg:justify-between gap-4 sm:gap-6 lg:gap-20">
            <div className="min-w-0">
              <h4 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4 whitespace-nowrap">Explore</h4>
            ...
            <div className="min-w-0">
              <h4 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4 whitespace-nowrap">Socials</h4>
          ...
          >
            <span
              className="absolute -bottom-2 sm:-bottom-2 md:-bottom-2 lg:-bottom-6 w-full text-center text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-black text-[#840000] leading-none whitespace-nowrap tracking-[0.05em] sm:tracking-[0.08em] md:tracking-[0.12em]"
            >
              Student Tribe
            </span>
          </div>
